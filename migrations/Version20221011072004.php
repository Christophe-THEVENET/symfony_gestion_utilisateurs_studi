 ...
 */
final class Version20221011072004 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'modif attribut user par owner';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE user_id owner_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE owner_id user_id INT DEFAULT NULL');
