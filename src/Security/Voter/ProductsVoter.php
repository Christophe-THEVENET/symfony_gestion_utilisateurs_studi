...
{ // les permissions
    ...
    public function __construct(private Security $security) // permet de vérifier les roles de l'utilisateur
    {
    } // *****************************************************


    // ************** on vérifie si les permissions qu'on demande existent dans le voter ******************
    protected function supports(string $attribute, $product): bool
    { // est ce qu'on peut éditer / supprimer
    ...
    // ************ vérifie si les critères demandés sont respectés pour les accées *****************************
